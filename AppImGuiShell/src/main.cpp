...
void theme(){
    ...
    colors[ImGuiCol_WindowBg] = ImVec4(0.166f,0.053f, 0.141f, 1.0f);
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
            ...
            if (ImGui::BeginTabBar("MyTabBar", tab_bar_flags))
            {
                ...
                for (int n = 0; n < active_tabs.Size; )
                {
                    ...
                    if (ImGui::BeginTabItem(name, &open, ImGuiTabItemFlags_None))
                    {
                        ...
                        ImGui::Text("This is some useful text.");               // Display some text (you can use a format strings too)
                        ImGui::Checkbox("Demo Window", &dockspaceOpen);      // Edit bools storing our window open/close state
                        ...
                        ImGui::SameLine();
                        ImGui::Text("counter = %d", counter);
                        ImGui::Text("This is some useful text1."); 
                        ImGui::Text("This is some useful text.2"); 
                        ImGui::Text("This is some useful text.3"); 
                        ImGui::Text("This is some useful text.4"); 
                        ImGui::Text("This is some useful text.5"); 
                        ImGui::Text("This is some useful text.6"); 
                        ImGui::Text("This is some useful text.7"); 
                        ImGui::Text("This is some useful text.8"); 
                        ImGui::Text("This is some useful text.9"); 
                        ImGui::Text("This is some useful text.1"); 
                        ImGui::Text("This is some useful text.2"); 
                        ImGui::Text("This is some useful text.3"); 
                        ImGui::Text("This is some useful text.4"); 
                        ImGui::Text("This is some useful text.5"); 
        ...
        if (ImGui::DockBuilderGetNode(dockspace_id) == nullptr) {
            ...
            //ImGuiID rightDown;
            ImGuiID rightUp = ImGui::DockBuilderSplitNode(center, ImGuiDir_Up, 0.65f, nullptr, &center);

            ImGui::DockBuilderDockWindow("menu", left);
            ImGui::DockBuilderDockWindow("lmenu", rightUp);
            ImGui::DockBuilderDockWindow("content", center); 
