...
void SwapChain::createSwapChain() {
  ...
  createInfo.imageUsage = VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT; // vk::ImageUsageFlagBits::eColorAttachment;;// 
  ...
  createInfo.compositeAlpha = VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; // vk::CompositeAlphaFlagBitsKHR::eOpaque; // 
...
void SwapChain::createRenderPass() {
  ...
  colorAttachment.format = (VkFormat )getSwapChainImageFormat();
