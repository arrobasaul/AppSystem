...
DescriptorPool::DescriptorPool(
  ...
  if (vkCreateDescriptorPool(_device.device(), &descriptorPoolInfo, nullptr, &descriptorPool) !=
      VK_SUCCESS) {
...
void DescriptorPool::resetPool() {
  vkResetDescriptorPool(_device.device(), descriptorPool, 0);
}
...
void DescriptorWriter::overwrite(VkDescriptorSet &set) {
  ...
  vkUpdateDescriptorSets(pool._device.device(), writes.size(), writes.data(), 0, nullptr);
}
